...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2['default'].createElement(_demo2['default'], null), document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _procedure = __webpack_require__(189);
	...
	var Demo = (function (_Component) {
		...
		_createClass(Demo, [{
			...
			key: 'next',
			value: function next() {
				this.setState(_procedure2['default'].next().value);
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2['default'].createElement(
					'div',
					{ className: 'demo', onClick: function () {
							return _this.next();
						} },
					_react2['default'].createElement(this.state.tag, { data: this.state.data })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var marked0$0 = [Procedure].map(_regeneratorRuntime.mark);

	var _intro = __webpack_require__(243);

	var _intro2 = _interopRequireDefault(_intro);

	var _encoding = __webpack_require__(244);
	...
	function Procedure() {
		var reverse;
		return _regeneratorRuntime.wrap(function Procedure$(context$1$0) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(192)(module), __webpack_require__(35)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY         = __webpack_require__(200)
	  ...
	  , SYMBOL_ITERATOR = __webpack_require__(206)('iterator')
	...
	module.exports = function(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCE){
	  __webpack_require__(210)(Constructor, NAME, next);
	  ...
	  if(_native){
	    ...
	    __webpack_require__(211)(IteratorPrototype, TAG, true);
	    // FF fix
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(name){
	  return store[name] || (store[name] =
	    Symbol && Symbol[name] || (Symbol || __webpack_require__(208))('Symbol.' + name));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(202)(IteratorPrototype, __webpack_require__(206)('iterator'), function(){ return this; });

	module.exports = function(Constructor, NAME, next){
	  Constructor.prototype = $.create(IteratorPrototype, {next: __webpack_require__(203)(1,next)});
	  __webpack_require__(211)(Constructor, NAME + ' Iterator');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(199)(Array, 'Array', function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(6)
	  ...
	  , strictNew  = __webpack_require__(218)
	  , forOf      = __webpack_require__(219)
	  , setProto   = __webpack_require__(21).set
	  , same       = __webpack_require__(224)
	  , species    = __webpack_require__(225)
	  , SPECIES    = __webpack_require__(206)('species')
	  , speciesConstructor = __webpack_require__(226)
	  , RECORD     = __webpack_require__(208)('record')
	  , asap       = __webpack_require__(227)
	  , PROMISE    = 'Promise'
	...
	var useNative = function(){
	  ...
	  try {
	    ...
	    if(works && __webpack_require__(204)){
	...
	if(!useNative){
	  ...
	  __webpack_require__(232)(P.prototype, {
	...
	__webpack_require__(211)(P, PROMISE);
	species(P);
	...
	$def($def.S + $def.F * !(useNative && __webpack_require__(233)(function(iter){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(C){
	  if(__webpack_require__(204) && !(SPECIES in C))$.setDesc(C, SPECIES, {
	    configurable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global    = __webpack_require__(14)
	  , macrotask = __webpack_require__(228).set
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SYMBOL_ITERATOR = __webpack_require__(206)('iterator')
	  , SAFE_CLOSING    = false;
	try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(196);
	__webpack_require__(212);
	module.exports = __webpack_require__(206)('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(!useNative){
	  ...
	  if(SUPPORT_DESC && !__webpack_require__(200)){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slicedToArray = __webpack_require__(253)['default'];
	...
	var Intro = (function (_Component) {
		...
		_createClass(Intro, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					'div',
					{ className: 'intro', onClick: function (e) {
							return _this.next(e);
						} },
					this.props.data.views[this.state.cur].map(function (i, j) {
						var _props$data$contents$i = _slicedToArray(_this.props.data.contents[i], 3);

						var Tag = _props$data$contents$i[0];
						var content = _props$data$contents$i[1];
						var className = _props$data$contents$i[2];

						if (Tag === 'img') {
							return _react2['default'].createElement(Tag, { key: j, className: className, src: content });
						} else {
							return _react2['default'].createElement(
								Tag,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getIterator = __webpack_require__(254)['default'];

	var _Map = __webpack_require__(277)['default'];
	...
	var Encoding = (function (_Component) {
		_inherits(Encoding, _Component);

		function Encoding() {
			_classCallCheck(this, Encoding);

			_get(Object.getPrototypeOf(Encoding.prototype), 'constructor', this).apply(this, arguments);
		}
		...
		_createClass(Encoding, [{
			...
			value: function charChange(e) {
				...
				try {
					for (var _iterator = _getIterator(e.target.value), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						var c = _step.value;
			...
			key: 'mod',
			value: function mod(str, len) {
				var slen = arguments.length <= 2 || arguments[2] === undefined ? len : arguments[2];
				return (function () {
					return ('0'.repeat((len - str.length % len) % len) + str).split('').reduce(function (pre, cur, i) {
						pre += cur;
						if ((i + 1) % slen === 0) {
							pre += ' ';
						}
			...
			key: 'getCodePointStrs',
			value: function getCodePointStrs() {
				var _this = this;

				return [[10, 1, 10], [2, 8], [8, 3], [16, 2]].map(function (_ref) {
					var _ref2 = _slicedToArray(_ref, 3);

					var d = _ref2[0];
					var n = _ref2[1];
					var m = _ref2[2];
					return _this.mod(_this.state.char.codePointAt(0).toString(d), n, m);
				});
			}
		}, {
			key: 'getUtf8Strs',
			value: function getUtf8Strs() {
				var _this2 = this;

				var s = encodeURI(this.state.char);
				if (s.includes('%')) {
					return [[2, 8], [8, 3], [16, 2]].map(function (_ref3) {
						var _ref32 = _slicedToArray(_ref3, 3);

						var d = _ref32[0];
						var n = _ref32[1];
						var m = _ref32[2];
						return _this2.mod(parseInt(s.replace(/%/g, ''), 16).toString(d), n);
					});
				} else {
					return [[2, 8], [8, 3], [16, 2]].map(function (_ref4) {
						var _ref42 = _slicedToArray(_ref4, 3);

						var d = _ref42[0];
						var n = _ref42[1];
						var m = _ref42[2];
						return _this2.mod(s.charCodeAt(0).toString(d), n);
					});
				}
			}
		}, {
			key: 'getUtf16Strs',
			value: function getUtf16Strs() {
				var _this3 = this;

				return [[2, 16, 8], [8, 3], [16, 4, 2]].map(function (_ref5) {
					var _ref52 = _slicedToArray(_ref5, 3);

					var d = _ref52[0];
					var n = _ref52[1];
					var m = _ref52[2];
					return _this3.state.char.split('').map(function (c) {
						return _this3.mod(c.charCodeAt(0).toString(d), n, m);
					}).join(' ');
				});
			}
		}, {
			...
			value: function getEscapeStrs() {
				...
				var htmlSpe = new _Map([[34, '&quot;'], [38, '&amp;'], [39, '&#39;'], [60, '&lt;'], [62, '&gt;']]).get(this.state.char.charCodeAt(0));
				if (htmlSpe) {
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					'div',
					{ className: 'encoding', onClick: function (e) {
							return _this4.next(e);
						} },
					_react2['default'].createElement(
						'h2',
						{ className: 'title' },
						'encoding inspection 演示'
					),
					_react2['default'].createElement(
						'div',
						{ className: 'content' },
						_react2['default'].createElement(
							...
							_react2['default'].createElement('input', { className: 'char', onChange: function (e) {
									return _this4.charChange(e);
								},
								...
								return _react2['default'].createElement(
									...
									_react2['default'].createElement(
										...
										_react2['default'].createElement(
											'div',
											{ className: 'key col' },
											['十进制', '二进制', '八进制', '十六进制'].map(function (s, i) {
												return _react2['default'].createElement(
													'p',
													{ key: i },
													s
										...
										_react2['default'].createElement(
											'div',
											{ className: 'value col' },
											_this4.getCodePointStrs().map(function (s, i) {
												return _react2['default'].createElement(
													'p',
													{ key: i },
													s
									...
									_react2['default'].createElement(
										...
										_react2['default'].createElement(
											'div',
											{ className: 'value col' },
											_this4.getUtf8Strs().map(function (s, i) {
												return _react2['default'].createElement(
													'p',
													{ key: i },
													s
									...
									_react2['default'].createElement(
										...
										_react2['default'].createElement(
											'div',
											{ className: 'value col' },
											_this4.getUtf16Strs().map(function (s, i) {
												return _react2['default'].createElement(
													'p',
													{ key: i },
													s
									...
									_react2['default'].createElement(
										...
										_react2['default'].createElement(
											'div',
											{ className: 'key col' },
											['反斜杠转义', '百分号转义', '实体引用转义'].map(function (s, i) {
												return _react2['default'].createElement(
													'p',
													{ key: i },
													s
										...
										_react2['default'].createElement(
											'div',
											{ className: 'value col' },
											_this4.getEscapeStrs().map(function (s, i) {
												return _react2['default'].createElement(
													'p',
													{ key: i },
													s
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./demo.sass", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./demo.sass");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".demo, .demo > div {\n  width: 100%;\n  height: 100%; }\n  .demo *, .demo > div * {\n    transition: all 1s;\n    -webkit-transition: all 1s;\n    -moz-transition: all 1s;\n    -ms-transition: all 1s; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isIterable = __webpack_require__(257)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./intro.sass", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./intro.sass");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./encoding.sass", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js?indentedSyntax!./encoding.sass");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".encoding {\n  background: #ccc;\n  display: -webkit-flex;\n  display: flex;\n  -webkit-flex-direction: column;\n  flex-direction: column;\n  -webkit-justify-content: space-around;\n  justify-content: space-around;\n  -webkit-align-items: stretch;\n  align-items: stretch; }\n  .encoding h2 {\n    height: 60px;\n    line-height: 60px;\n    text-align: center; }\n  .encoding .content {\n    display: -webkit-flex;\n    display: flex;\n    -webkit-justify-content: space-around;\n    justify-content: space-around;\n    -webkit-flex-grow: 1;\n    flex-grow: 1; }\n    .encoding .content .input, .encoding .content .output {\n      display: -webkit-flex;\n      display: flex;\n      -webkit-flex-direction: column;\n      flex-direction: column;\n      -webkit-justify-content: space-around;\n      justify-content: space-around;\n      -webkit-flex-grow: 1;\n      flex-grow: 1; }\n    .encoding .content .input {\n      -webkit-align-items: center;\n      align-items: center; }\n      .encoding .content .input .char {\n        width: 100px;\n        height: 100px;\n        font-size: 80px;\n        line-height: 100px;\n        text-align: center; }\n    .encoding .content .output {\n      -webkit-align-items: center;\n      align-items: center; }\n      .encoding .content .output .row {\n        display: -webkit-flex;\n        display: flex;\n        -webkit-flex-direction: row-reverse;\n        flex-direction: row-reverse;\n        -webkit-justify-content: space-around;\n        justify-content: space-around;\n        width: 80%; }\n        .encoding .content .output .row .col {\n          display: -webkit-flex;\n          display: flex;\n          -webkit-flex-direction: column;\n          flex-direction: column;\n          -webkit-justify-content: space-around;\n          justify-content: space-around; }\n        .encoding .content .output .row .key {\n          width: 180px;\n          text-align: center; }\n        .encoding .content .output .row .value {\n          -webkit-flex-grow: 1;\n          flex-grow: 1;\n          text-align: right; }\n        .encoding .content .output .row p {\n          font-size: 20px;\n          height: 30px;\n          line-height: 30px;\n          border-bottom: solid 1px #333; }\n  .encoding .next {\n    position: fixed;\n    cursor: pointer;\n    bottom: 30px;\n    right: 30px;\n    color: blue; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 23.1 Map Objects
	__webpack_require__(281)('Map', function(get){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  getConstructor: function(wrapper, NAME, IS_MAP, ADDER){
	    ...
	    __webpack_require__(232)(C.prototype, {
	  ...
	  setStrong: function(C, NAME, IS_MAP){
	    ...
	    __webpack_require__(199)(C, NAME, function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(NAME, wrapper, methods, common, IS_MAP, IS_WEAK){
	  var Base  = __webpack_require__(14)[NAME]
	    ...
	    , proto = C && C.prototype
	    , O     = {};
	  if(!__webpack_require__(204) || typeof C != 'function'
	    || !(IS_WEAK || proto.forEach && !__webpack_require__(16)(function(){ new C().entries().next(); }))
	  ){
	    // create collection constructor
	    C = common.getConstructor(wrapper, NAME, IS_MAP, ADDER);
	    __webpack_require__(232)(C.prototype, methods);
	  } else {
	  ...
	  __webpack_require__(211)(C, NAME);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.P, 'Map', {toJSON: __webpack_require__(283)('Map')});
